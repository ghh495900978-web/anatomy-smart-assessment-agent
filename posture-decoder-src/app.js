...
{id:67,type:"single",layer:"运动动作分析",comp:"L4",knowledgePoint:"引体向上的原动肌",prompt:"完成「引体向上」拉起身体动作时，肩关节内收与肘关节屈曲的主要原动肌是？",options:["背阔肌与大圆肌","胸大肌","三角肌前束","肱三头肌"],correct:"A",score:10,errorType:"D",brief:"引体向上原动肌",scene:"为客户设计背部力量训练方案时，需明确引体向上主要锻炼哪些肌群。",explain:"引体向上拉起阶段，背阔肌和大圆肌是肩关节内收与伸的主要原动肌；肱二头肌是肘关节屈的原动肌。胸大肌参与但不主导，三角肌前束和肱三头肌在此动作中非主要发力肌。"},
{id:68,type:"single",layer:"运动动作分析",comp:"L4",knowledgePoint:"深蹲蹲起的原动肌",prompt:"深蹲站起过程中，伸髋与伸膝的主要原动肌分别是？",options:["臀大肌与股四头肌","腘绳肌与小腿三头肌","髂腰肌与胫骨前肌","臀中肌与股四头肌"],correct:"A",score:10,errorType:"D",brief:"深蹲原动肌",scene:"指导社区老年人进行防跌倒力量训练时，需讲清深蹲锻炼的目标肌群。",explain:"深蹲站起时，臀大肌是髋关节伸的主要原动肌，股四头肌是膝关节伸的主要原动肌。两者协同产生站起动力。腘绳肌在深蹲中辅助伸髋但非主导；髂腰肌主屈髋、胫骨前肌主踝背屈，均不负责站起。"},
{id:69,type:"multiple",layer:"运动动作分析",comp:"L3",knowledgePoint:"俯卧撑推起的原动肌",prompt:"标准俯卧撑推起过程中，参与作为原动肌的包括？",options:["胸大肌","三角肌前束","肱三头肌","背阔肌"],correct:["A","B","C"],score:10,errorType:"D",brief:"俯卧撑原动肌",scene:"为上肢力量较弱的客户设计退阶俯卧撑训练时，需明确目标肌群。",explain:"俯卧撑推起时，胸大肌负责肩关节水平内收和伸，三角肌前束负责肩关节屈，肱三头肌负责肘关节伸——三者均为原动肌。背阔肌在此动作中不主动收缩。"},
{id:70,type:"single",layer:"运动动作分析",comp:"L3",knowledgePoint:"肌肉协作角色概念",prompt:"在肘关节屈曲动作中，肱二头肌收缩产生动力、肱三头肌被拉长——此时肱三头肌的角色是？",options:["原动肌","对抗肌","固定肌","中和肌"],correct:"B",score:10,errorType:"A",brief:"对抗肌概念",scene:"向客户解释为何拉伸肱三头肌有助于提升屈肘柔韧性时，需先讲清对抗肌关系。",explain:"原动肌是直接完成动作的肌肉（此处为肱二头肌）；对抗肌是与原动肌作用相反、在动作中被拉长的肌肉（此处为肱三头肌）。固定肌固定近端肢体，中和肌消除不必要的附加动作。"},
{id:71,type:"single",layer:"运动动作分析",comp:"L4",knowledgePoint:"固定肌与中和肌的作用",prompt:"做「哑铃弯举」时，若三角肌前束也参与收缩导致肩关节意外屈曲，需要哪类肌来消除这个多余动作？",options:["中和肌","对抗肌","固定肌","协同肌"],correct:"A",score:10,errorType:"A",brief:"中和肌的作用",scene:"指导初学者进行孤立训练时，常出现代偿现象，需解释中和肌的作用。",explain:"中和肌的作用是抵消原动肌产生的多余附属动作。弯举时肱二头肌有肩屈功能，若不需要肩屈，则需后侧肌群（如背阔肌等）作为中和肌来抵消该多余动作，保证动作纯粹性。"},
{id:72,type:"single",layer:"运动动作分析",comp:"L3",knowledgePoint:"克制性与退让性工作",prompt:"从杠上缓慢下放身体（离心阶段）的过程中，背阔肌的工作性质属于？",options:["克制性工作（向心收缩）","退让性工作（离心收缩）","支持工作","加固工作"],correct:"B",score:10,errorType:"A",brief:"退让性工作",scene:"为客户设计下坡走或下楼梯康复训练时，需解释离心收缩的力学特点。",explain:"肌肉在被拉长时仍保持收缩张力称为退让性工作（离心收缩），如下放重物、下坡行走、下楼梯时的股四头肌和臀大肌。克制性工作则是肌肉缩短时产生张力（向心收缩）。退让性工作更易造成肌肉微损伤和延迟性酸痛。"},
{id:73,type:"multiple",layer:"运动动作分析",comp:"L3",knowledgePoint:"静力性工作的类型",prompt:"下列属于静力性工作的是？",options:["平板支撑中腹横肌的支持工作","硬拉顶峰时竖脊肌的加固工作","引体向上拉起时背阔肌的克制性工作","体操十字支撑时肩带肌的固定工作"],correct:["A","B","D"],score:10,errorType:"A",brief:"静力性工作分类",scene:"为久坐办公族设计核心稳定性训练方案时，需区分不同类型的静力性收缩。",explain:"静力性工作时肌肉长度不变但维持张力：支持工作（如平板支撑腹肌抵抗重力）、加固工作（如硬拉顶峰竖脊肌稳定脊柱）、固定工作（如体操中固定关节）。C选项中背阔肌缩短产生动力，属动力性克制工作。"},
{id:74,type:"single",layer:"运动动作分析",comp:"L4",knowledgePoint:"实际工作中的工作性质判断",prompt:"客户手提重物从地面缓慢提起至腰部高度再放下，整个过程中股四头肌先后经历的工作性质是？",options:["退让性→克制性→退让性","克制性→退让性→克制性","克制性→静力性→退让性","退让性→静力性→克制性"],correct:"A",score:10,errorType:"D",brief:"完整动作中的工作性质变化",scene:"指导搬运工正确提物姿势以减少腰膝损伤风险时，需分析各阶段的肌肉工作性质。",explain:"下蹲取物时股四头肌被拉长但仍收缩（退让性/离心）；站起时股四头肌缩短产生动力（克制性/向心）；缓慢放下重物时再次被拉长（退让性/离心）。理解这一循环对预防运动损伤至关重要。"},
{id:75,type:"single",layer:"运动动作分析",comp:"L4",knowledgePoint:"多关节肌的主动不足",prompt:"一位客户在做「坐姿腿屈伸」后立即尝试充分屈髋（触脚尖），发现大腿后侧明显紧绷无法完成——这种现象称为？",options:["多关节肌的主动不足","多关节肌的被动不足","肌肉痉挛","关节活动度受限"],correct:"A",score:10,errorType:"A",brief:"主动不足",scene:"客户反映练完腿后弯腰困难，需解释这是正常的生理现象而非损伤。",explain:"主动不足是指多关节肌在一个关节处已缩短收缩后，在另一关节处不能再充分收缩的现象。腘绳肌跨髋膝两关节，伸膝后已缩短，再屈髋时无法进一步收缩产生足够张力，故感觉紧绷。这与被动不足（肌肉被拉长到极限）不同。"},
{id:76,type:"single",layer:"运动动作分析",comp:"L4",knowledgePoint:"多关节肌的被动不足",prompt:"当膝关节完全伸直后再试图充分屈髋（直膝前屈），大腿后侧强烈牵拉感限制动作幅度——这属于？",options:["多关节肌的被动不足","多关节肌的主动不足","韧带限制","骨性阻挡"],correct:"A",score:10,errorType:"A",brief:"被动不足",scene:"评估客户腘绳肌柔韧性时，需区分主动不足与被动不足以选择正确的测试方法。",explain:"被动不足是指多关节肌在一个关节已被拉长的情况下，在另一关节不能再进一步拉长的现象。直膝前屈时腘绳肌在膝关节已伸直（拉长），再屈髋进一步拉长到达极限即产生被动不足。这是正常生理限制，不是病理性的。"},
{id:77,type:"single",layer:"运动动作分析",comp:"L3",knowledgePoint:"人体杠杆的三种类型",prompt:"站立时踮起脚尖（提踵），以跖骨头为支点、体重通过距骨体向下、小腿三头肌跟腱向上拉——这属于哪种杠杆？",options:["省力杠杆（第二类）","平衡杠杆（第一类）","速度杠杆（第三类）","不属于杠杆"],correct:"A",score:10,errorType:"A",brief:"省力杠杆实例",scene:"解释为何提踵训练能有效增强小腿三头肌力量时，可用杠杆原理说明力学优势。",explain:"提踵时支点在前（跖骨头），阻力（体重）在中间（距骨），动力（小腿三头肌跟腱）在后——阻力位于支点与动力之间，属于第二类省力杠杆，机械利益大于1，但运动幅度和速度较小。"},
{id:78,type:"single",layer:"运动动作分析",comp:"L3",knowledgePoint:"速度杠杆的特点",prompt:"人体大多数关节（如肘关节屈曲、肩关节外展）属于速度杠杆（第三类），其特点是？",options:["动力臂小于阻力臂，费力但速度快、幅度大","动力臂大于阻力臂，省力但速度慢","动力臂等于阻力臂，力与速度均衡","不存在明确的力臂关系"],correct:"A",score:10,errorType:"A",brief:"速度杠杆特点",scene:"向客户解释为何增加负重能显著提升肌肉刺激时，可引用速度杠杆的力学劣势。",explain:"第三类杠杆（速度杠杆）的动力点位于支点和阻力点之间，动力臂小于阻力臂，机械利益小于1——虽然费力，但能获得较大的运动幅度和末端速度。人体大部分骨骼肌附着靠近关节，形成速度杠杆，牺牲力的优势换取运动范围和速度。"},
{id:79,type:"multiple",layer:"运动动作分析",comp:"L4",knowledgePoint:"杠杆原理在健康评估中的应用",prompt:"根据杠杆原理，以下说法正确的是？",options:["手持重物远离身体会显著增加脊柱负荷（力臂增大）","弯腰搬重物时腰椎受力远大于直立搬运","提踵属于省力杠杆，适合康复初期肌力不足者","所有上肢动作都属于速度杠杆"],correct:["A","B","C"],score:10,errorType:"D",brief:"杠杆原理应用",scene:"为办公室人群制定腰背保护指南时，用杠杆原理解释不良姿势的危害。",explain:"A正确：力臂=重物到腰椎的距离，远离身体增大力矩。B正确：弯腰时躯干重力+重物的力臂都很大，腰椎承受数倍于直立时的压力。C正确：提踵是第二类杠杆（省力），适合肌力弱者。D错误：并非所有上肢动作都是速度杠杆，如提踵就是省力杠杆。"},
{id:80,type:"single",layer:"运动动作分析",comp:"L4",knowledgePoint:"正常姿势的评价标准",prompt:"从解剖学角度评价人体正面观姿势时，以下哪项属于正常标准？",options:["双耳、双肩、双髂前上棘、双膝、双踝大致在同一水平面","耳屏应位于肩峰正前方超过2cm","骨盆应轻度前倾约15°以上","膝关节应呈轻度过伸位"],correct:"A",score:10,errorType:"C",brief:"正常姿势标准",scene:"为新入校学生进行体态筛查时，需依据正常解剖标准判断偏离程度。",explain:"正常正面观姿势要求双侧对称：双耳、双肩、双髂前上棘、双膝、双踝基本在同一水平线上。耳屏在肩峰前方>2cm提示头前伸；骨盆前倾>15°属异常；膝过伸也非正常标准。"},
{id:81,type:"single",layer:"运动动作分析",comp:"L5",knowledgePoint:"综合：动作分析与干预建议",prompt:"一位长期伏案的程序员主诉颈肩酸痛、头部前倾。从运动解剖学角度分析，最优先的干预方向是？",options:["强化颈深屈肌与中下斜方肌，牵伸胸锁乳突肌与胸大肌","强化胸大肌以改善含胸体态","单纯进行颈椎牵引即可缓解","避免一切上肢运动直至症状消失"],correct:"A",score:10,errorType:"D",brief:"综合干预建议",scene:"作为健康管理师面对典型办公族体态问题，需给出基于解剖学的循证干预方向。",explain:"头前伸伴颈肩痛的典型模式是：颈深屈肌和中下斜方肌薄弱（需强化），胸锁乳突肌、肩胛提肌、上斜方肌和胸大肌紧张短缩（需牵伸）。这是上交叉综合征的经典干预策略。B选项反其道而行会加重问题；C和D均未解决肌力失衡的根本原因。"}
]},
...
let chatHistory = [];
const SYSTEM_PROMPT = `你是「肌骨解码师·运动系统智能体」内置的 AI 伴学助手，面向健康服务与管理专业大一学生。你的职责：
...
function mockLLM(prompt){
  ...
  if(/你好|hi|hello|你是|什么/.test(lower)){
    return `你好！我是「肌骨解码师·运动系统智能体」内置的 AI 伴学助手 🤖\n\n我能帮你：\n• 解释运动系统与体态评估知识点\n• 分析原动肌与肌肉协作关系\n• 解析错题思路并推荐学习路径\n• 讲解动作分析的杠杆原理\n\n试试问我：「引体向上的原动肌是什么」、「什么是多关节肌主动不足」、「我下一步该学什么」`;
  }
  // 默认
...
function downloadSummary(){
  const md = `# 肌骨解码师 · 运动系统智能体 · 建设说明书摘要

## 一、智能体概述
- **名称**：肌骨解码师·运动系统智能体（参考北体《运动解剖学》第3版）
- **目标用户**：健康服务与管理专业大一学生
